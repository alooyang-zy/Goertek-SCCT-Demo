...
function buildRisks(){
  ...
  var cats = [
    {d:'一、内部运营风险',items:[
      ...
      {code:'R-1.4',name:'需求突增·供应断裂',level:'高'},{code:'R-1.5',name:'需求突减·库存呆滞',level:'中'},
  ...
  cats.forEach(function(c){
    c.items.forEach(function(it){
      var descArr={'R-1.1':'客户滚动预测与实际订单偏差超25%，导致计划失效','R-1.4':'客户爆量追加>30%，预测模型失效→产能挤兑→紧急采购成本飙升→交付缺口连锁','R-1.5':'连续3周订单低于基线40%，牛鞭效应逆传导→库存水位飙升→E&O冲销风险','R-3.2':'供应商多次延迟交付，OTD<70%','R-6.1':'核心供应商产能利用率>95%，无弹性空间','R-6.3':'独家供料断供，无替代方案','R-2.1':'NPI项目里程碑延期，客户违约风险','R-5.2':'需求取消/ECN变更导致物料呆滞，高账龄库存持续累积','R-2.2':'客户ECN频繁且窗口极短，信息同步脱节导致旧料误用或新料未备','R-10.1':'客户砍单>30%，库存积压'};
      var impArr={'R-1.1':'交付延误>5天，客户投诉升级','R-1.4':'紧急采购溢价>20%+停线风险+客户索赔，三重叠加','R-1.5':'库存E&O计提侵蚀利润，供应商MOQ违约+关系破裂','R-3.2':'关键料号断供，生产线停线','R-6.1':'Tier-1断供，影响>5条产线','R-6.3':'独家供料断供，无替代方案','R-2.1':'NPI延期，客户里程碑违约','R-5.2':'库存直接沉淀为报废损失，持续侵蚀利润','R-2.2':'旧料误用/新料未备/批量报废，代工业利润损耗最高风险','R-10.1':'客户砍单>30%，库存积压'};
